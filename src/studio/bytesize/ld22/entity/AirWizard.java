...
public class AirWizard extends Mob
{
	...
	public void render(Screen screen)
	{
		...
		if (hurtTime > 0)
		{
			col1 = Color.get(-1, 555, 555, 555); // Render mob white (because it's hit)
			col2 = Color.get(-1, 555, 555, 555); // Render mob white (because it's hit)
		}
	...
	protected void touchedBy(Entity entity)
	{
		...
		{
			entity.hurt(this, 3, ((Player)entity).dir ^ 1);
		}
	}
